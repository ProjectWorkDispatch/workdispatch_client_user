          ...
          <CardContent className="p-6">
            ...
            {meeting.status === "CONFIRMED" ? (
              <div className="rounded-lg bg-emerald-50 dark:bg-emerald-900/30 p-4">
                ...
                {meeting.meetLink && (
                  <a href={meeting.meetLink} target="_blank" rel="noopener noreferrer" className="mt-1 inline-block text-sm font-bold text-blue-600 dark:text-blue-400 underline">Abrir Google Meet</a>
                )}
              </div>
            ) : (
