...
const NORMALIZED_STATUS = {
  PENDING: { label: "Propuesta pendiente", class: "bg-yellow-50 text-yellow-700 border-yellow-200" },
  ACCEPTED: { label: "Propuesta aceptada", class: "bg-emerald-50 text-emerald-700 border-emerald-200" },
  ...
  IN_PROGRESS: { label: "Trabajo en curso", class: "bg-sky-50 text-sky-700 border-sky-200" },
  COMPLETED: { label: "Finalizado", class: "bg-emerald-50 text-emerald-700 border-emerald-200" },
};
...
export const WorkerMyJobsPage = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-black text-gray-900">Mis Trabajos</h1>
        <p className="mt-1 text-gray-600">Propuestas enviadas y servicios activos en un solo lugar.</p>
      </div>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          {loading ? (
            <p className="py-10 text-center text-sm font-semibold text-gray-500">Cargando trabajos...</p>
              ...
              {filteredItems.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="rounded-lg border border-gray-200 bg-white p-4 transition hover:border-yellow-300 cursor-pointer"
                    onClick={() => {
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="mb-2 flex flex-wrap items-center gap-2">
                          <span
                            className={`inline-flex rounded-md border px-2 py-0.5 text-xs font-bold ${statusInfo?.class || "bg-gray-100 text-gray-600 border-gray-200"}`}
                          >
            ...
            <div className="py-12 text-center">
              ...
              <p className="text-lg font-bold text-gray-500">No hay trabajos en este filtro</p>
