...
export const WorkerDashboardSummary = ({ user }) => {
  ...
  const stats = [
    { label: "Trabajos Disponibles", value: filteredJobs.length, icon: BriefcaseIcon, bg: "bg-yellow-50 dark:bg-yellow-900/30", border: "border-yellow-200 dark:border-yellow-800", color: "text-yellow-600 dark:text-yellow-400" },
    { label: "Mis Ofertas", value: pendingProposals.length, icon: ClipboardDocumentListIcon, bg: "bg-gray-100 dark:bg-gray-700", border: "border-gray-300 dark:border-gray-600", color: "text-gray-700 dark:text-gray-300" },
    { label: "En Curso", value: activeServices.length, icon: CheckCircleIcon, bg: "bg-gray-200 dark:bg-gray-600", border: "border-gray-400 dark:border-gray-500", color: "text-gray-900 dark:text-gray-100" },
  ];
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-gray-900 dark:text-gray-100">Dashboard de Trabajador</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Revisa trabajos disponibles, ofertas enviadas y trabajos en curso</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="lg:col-span-2">
          <CardContent className="p-6">
            <div className="mb-4">
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">Buscar trabajos disponibles</h2>
            ...
            <div className="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-[1fr_220px]">
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 pl-10 pr-3 text-sm text-gray-900 dark:text-gray-100 outline-none transition focus:border-yellow-400 focus:ring-2 focus:ring-yellow-100"
                />
              </div>
              <select
                value={selectedCategoryId}
                onChange={(event) => setSelectedCategoryId(event.target.value)}
                className="h-11 w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 text-sm font-semibold text-gray-700 dark:text-gray-300 outline-none transition focus:border-yellow-400 focus:ring-2 focus:ring-yellow-100"
              >
            ...
            {loadingWorkerData ? (
              ...
              <div className="space-y-4">
                  ...
                  <div key={job._id || job.id} className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3">
                    <div className="flex gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">{formatDate(job.createdAt)}</p>
                      </div>
                    </div>
                ...
                {totalJobPages > 1 && (
                  <div className="flex flex-col gap-3 border-t border-gray-100 dark:border-gray-800 pt-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={jobsPage === 1}
                        className="h-9 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 text-sm font-bold text-gray-700 dark:text-gray-300 transition hover:border-yellow-400 hover:bg-yellow-50 disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        Anterior
                      </button>
                      <button
              ...
              <div className="py-10 text-center">
                <BriefcaseIcon className="size-12 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
                <p className="text-gray-500 dark:text-gray-400 text-lg mb-2">No hay trabajos con esos filtros</p>
                <p className="text-gray-400 dark:text-gray-500 text-sm">Prueba otra categoria o cambia la busqueda.</p>
              </div>
            )}
          </CardContent>
        </Card>
